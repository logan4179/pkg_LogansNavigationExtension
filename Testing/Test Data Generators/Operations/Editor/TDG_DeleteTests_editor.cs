...
{
	[CustomEditor(typeof(TDG_DeleteTests)), CanEditMultipleObjects]
	public class TDG_DeleteTests_editor : Editor
    {
		TDG_DeleteTests _targetScript;

		private void OnEnable()
		{
			_targetScript = ( TDG_DeleteTests )target;
		}
