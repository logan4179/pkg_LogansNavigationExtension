...
{
    public class TDG_MoveComponents : MonoBehaviour
    {
		...
		public void RecreateMeFromJson()
		{
			...
			{
				Debug.LogError($"path '{TDG_Manager.filePath_testData_moveComponents}' didn't exist. returning early...");
				return;
			}

			string myJsonString = File.ReadAllText( TDG_Manager.filePath_testData_moveComponents );
