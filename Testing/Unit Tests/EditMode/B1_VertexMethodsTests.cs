	...
	public class B1_VertexMethodsTests
	{
		...
		public void b1_IsInCenterSweep()
		{
			...
			for ( int i = 0; i < _tdg_isInCenterSweep.CapturedStartPositions.Count; i++ )
			{
				...
				bool rslt = vert0.IsInCenterSweep( _tdg_isInCenterSweep.CapturedStartPositions[i], _serializedLNXNavmesh.GetSurfaceProjectionVector() );
				...
				rslt = vert1.IsInCenterSweep(_tdg_isInCenterSweep.CapturedStartPositions[i], _serializedLNXNavmesh.GetSurfaceProjectionVector());
				...
				rslt = vert2.IsInCenterSweep(_tdg_isInCenterSweep.CapturedStartPositions[i], _serializedLNXNavmesh.GetSurfaceProjectionVector());
