...
namespace LoganLand.LogansNavmeshExtension.Tests
{
    public class D_DeletingTests
    {
		...
		public void b1_TriangleCountIsOneLessAfterDeletion()
		{
			...
			Debug.Log($"Currently have '{_lnx_meshManipulator.indices_selectedTris.Count}' tris selected (there should only be one). Attempting delete...");
